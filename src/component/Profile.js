...
const Profile = () => {
  ...
  return (
    ...
    >
      <Typography
        variant="h5"
        style={{ textAlign: "center", marginTop: "80px", color: "white" }}
      >
        Student Progress
      </Typography>
      <Box
      ...
      {loading ? (
        ...
        <>
          {/* Profile Card */}
          <Card style={{ width: "90%", maxWidth: 600, margin: "20px 0" }}>
            <CardContent>
              <Box
                style={{
                  display: "flex",
              ...
              >
                ...
                >
                  Email: {profileData?.profile[0]?.email}
                </Typography>
                <Typography
                  style={{
                    fontSize: "15px",
                ...
                >
                  Role: {profileData?.profile[0]?.role}
                </Typography>
                <Typography
                  style={{
                    fontSize: "15px",
                ...
                >
                  Education {profileData?.profile[0]?.education}
                </Typography>
                <Typography
                  style={{
                    fontSize: "15px",
                ...
                >
                  Skills: {profileData?.profile[0]?.skills}
                </Typography>
